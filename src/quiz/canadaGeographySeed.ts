...
export const CANADA_GEOGRAPHY_SEED: QuizQuestion[] = [
  // --- capitals (choice) ---------------------------------------------------
  choice('cg-01', 'What is the capital city of Canada?', ['Toronto', 'Ottawa', 'Montreal', 'Vancouver'], 'Ottawa', {
    emoji: '🏛️',
    funFact: 'Ottawa was picked partly because it was far from the US border — a safe spot for the King’s treasure… er, Parliament.',
  }),
  choice('cg-02', 'What is the capital of Quebec?', ['Montreal', 'Québec City', 'Laval', 'Gatineau'], 'Québec City', {
    emoji: '🏰',
  ...
  choice('cg-03', 'What is the capital of British Columbia?', ['Vancouver', 'Victoria', 'Kelowna', 'Surrey'], 'Victoria', {
    emoji: '⛵',
  ...
  choice('cg-04', 'What is the capital of Alberta?', ['Calgary', 'Edmonton', 'Red Deer', 'Banff'], 'Edmonton', {
    emoji: '🛢️',
    funFact: 'Edmonton has one of the biggest shopping malls in North America — with a pirate ship inside it. Seriously.',
  }),
  choice('cg-05', 'What is the capital of Saskatchewan?', ['Saskatoon', 'Regina', 'Moose Jaw', 'Prince Albert'], 'Regina', {
    emoji: '🌾',
    funFact: '“Regina” means “queen” in Latin. The RCMP (Mounties) train there.',
  }),
  choice('cg-06', 'What is the capital of New Brunswick?', ['Moncton', 'Saint John', 'Fredericton', 'Bathurst'], 'Fredericton', {
    emoji: '🦞',
    funFact: 'Everyone guesses Moncton or Saint John — but quiet little Fredericton holds the crown.',
  }),
  choice('cg-07', 'What is the capital of Newfoundland and Labrador?', ['Corner Brook', 'Gander', "St. John's", 'Labrador City'], "St. John's", {
    emoji: '🌊',
  ...
  choice('cg-08', 'What is the capital of Yukon?', ['Dawson City', 'Whitehorse', 'Watson Lake', 'Haines Junction'], 'Whitehorse', {
    emoji: '🐺',
    funFact: 'Whitehorse is named after river rapids that looked like the manes of white horses.',
  }),
  choice('cg-09', 'What is the capital of the Northwest Territories?', ['Inuvik', 'Hay River', 'Yellowknife', 'Norman Wells'], 'Yellowknife', {
    emoji: '💎',
    funFact: 'Yellowknife sits on gold AND diamonds. An actual treasure island, no map needed.',
  }),
  choice('cg-10', 'What is the capital of Nunavut?', ['Iqaluit', 'Rankin Inlet', 'Arviat', 'Igloolik'], 'Iqaluit', {
    emoji: '❄️',
    funFact: '“Iqaluit” means “place of many fish” in Inuktitut. Sanji would approve.',
  }),

  // --- provinces / territories basics --------------------------------------
  choice('cg-11', 'How many provinces does Canada have?', ['8', '10', '12', '13'], '10', {
    emoji: '🗺️',
    funFact: '10 provinces + 3 territories = 13 regions. Newfoundland joined last, in 1949.',
  }),
  choice('cg-12', 'How many territories does Canada have?', ['2', '3', '4', '5'], '3', {
    emoji: '🧭',
    funFact: 'Yukon, Northwest Territories and Nunavut. Nunavut is the newest — created in 1999.',
  }),
  choice('cg-13', 'What are the two official languages of Canada?', ['English and Spanish', 'English and French', 'French and Inuktitut', 'English only'], 'English and French', {
    emoji: '🗣️',
    funFact: 'That’s why cereal boxes have two sides — English on one, français on the other!',
  }),
  choice('cg-14', 'In which province is French the ONLY official language?', ['Ontario', 'New Brunswick', 'Quebec', 'Manitoba'], 'Quebec', {
    emoji: '⚜️',
    funFact: 'About 8 in 10 Quebecers speak French at home. Bonjour-Hi!',
  }),
  choice('cg-15', 'Which is the only officially bilingual province (English AND French)?', ['Quebec', 'Ontario', 'Manitoba', 'New Brunswick'], 'New Brunswick', {
    emoji: '🤝',
    funFact: 'New Brunswick runs everything in both languages — the only province that does.',
  }),
  choice('cg-16', 'Inuktitut is an official language of which territory?', ['Yukon', 'Nunavut', 'Northwest Territories', 'Labrador'], 'Nunavut', {
    emoji: '🐻‍❄️',
    funFact: 'The Northwest Territories go even further — they have ELEVEN official languages.',
  }),

  // --- oceans & neighbours -------------------------------------------------
  choice('cg-17', 'Which ocean touches Canada’s WEST coast?', ['Atlantic', 'Arctic', 'Pacific', 'Indian'], 'Pacific', {
    emoji: '🌅',
    funFact: 'Pacific = west = British Columbia. Home of orcas and giant octopuses — real Sea Kings.',
  }),
  choice('cg-18', 'Which ocean touches Canada’s EAST coast?', ['Pacific', 'Atlantic', 'Arctic', 'Southern'], 'Atlantic', {
    emoji: '🌊',
    funFact: 'The Titanic sank in the Atlantic off Newfoundland. Wreck divers still visit from St. John’s.',
  }),
  choice('cg-19', 'Which ocean is to the NORTH of Canada?', ['Atlantic', 'Pacific', 'Arctic', 'Baltic'], 'Arctic', {
    emoji: '🧊',
    funFact: 'Canada touches three oceans — that’s why its motto is “From sea to sea”.',
  }),
  choice('cg-20', 'Which country is Canada’s only land neighbour?', ['Russia', 'United States', 'Greenland', 'Mexico'], 'United States', {
    emoji: '🛂',
    funFact: 'The Canada–US border is the longest land border in the world: almost 9,000 km!',
  }),
  choice('cg-21', 'Which province is the BIGGEST by area?', ['Ontario', 'British Columbia', 'Quebec', 'Alberta'], 'Quebec', {
    emoji: '📏',
    funFact: 'Quebec is about 3× the size of France. Ontario is #2.',
  }),
  choice('cg-22', 'Which province is the SMALLEST?', ['Nova Scotia', 'Prince Edward Island', 'New Brunswick', 'Manitoba'], 'Prince Edward Island', {
    emoji: '🥔',
    funFact: 'Tiny PEI grows a quarter of Canada’s potatoes. Small island, big fries.',
  }),

  // --- province & territory flags (images) ---------------------------------
  choice('cg-23', 'Which province does this flag belong to?', ['Ontario', 'Manitoba', 'British Columbia', 'Alberta'], 'Ontario', {
    emoji: '🚩',
  ...
  choice('cg-24', 'Which province flies this flag?', ['New Brunswick', 'Quebec', 'Nova Scotia', 'Prince Edward Island'], 'Quebec', {
    emoji: '🚩',
    image: flag('Flag_of_Quebec.svg'),
    funFact: 'The white symbols are fleurs-de-lis — lilies, an old symbol of France.',
  }),
  choice('cg-25', 'Which province does this flag (sun setting over waves) belong to?', ['Alberta', 'British Columbia', 'Newfoundland and Labrador', 'Yukon'], 'British Columbia', {
    emoji: '🚩',
    image: flag('Flag_of_British_Columbia.svg'),
    funFact: 'The sun sits over wavy blue lines = the Pacific Ocean. West coast, best coast?',
  }),
  choice('cg-26', 'Which province flies this blue flag with a white-and-blue shield?', ['Nova Scotia', 'New Brunswick', 'Manitoba', 'Saskatchewan'], 'Nova Scotia', {
    emoji: '🚩',
  ...
  choice('cg-27', 'Which territory has this flag with an inuksuk (stone figure)?', ['Yukon', 'Northwest Territories', 'Nunavut', 'Nunavik'], 'Nunavut', {
    emoji: '🚩',
  ...
  choice('cg-28', 'Which province flies this flag?', ['Nova Scotia', 'Newfoundland and Labrador', 'Prince Edward Island', 'New Brunswick'], 'Newfoundland and Labrador', {
    emoji: '🚩',
  ...
  choice('cg-29', 'Which territory does this flag belong to?', ['Nunavut', 'Yukon', 'Northwest Territories', 'Alaska'], 'Yukon', {
    emoji: '🚩',
  ...
  choice('cg-30', 'This flag (a “T” shaped like city hall) belongs to which city?', ['Ottawa', 'Toronto', 'Hamilton', 'Mississauga'], 'Toronto', {
    emoji: '🏙️',
  ...
  choice('cg-31', 'This flag with a red cross and four symbols belongs to which city?', ['Quebec City', 'Montreal', 'Laval', 'Sherbrooke'], 'Montreal', {
    emoji: '🏙️',
  ...
  choice('cg-32', 'This flag with waves and a golden sun belongs to which west-coast city?', ['Victoria', 'Seattle', 'Vancouver', 'Whistler'], 'Vancouver', {
    emoji: '🏙️',
  ...
  choice('cg-33', 'Niagara Falls is in which province?', ['Quebec', 'Ontario', 'Manitoba', 'British Columbia'], 'Ontario', {
    emoji: '💦',
    weight: 1,
    points: 5,
    funFact: 'Enough water goes over Niagara Falls every second to fill an Olympic pool. All Blue vibes.',
  }),
  choice('cg-34', 'Banff and the Rocky Mountains are famous in which province?', ['Saskatchewan', 'Ontario', 'Alberta', 'Nova Scotia'], 'Alberta', {
    emoji: '🏔️',
    weight: 1,
    points: 5,
    funFact: 'Banff was Canada’s FIRST national park (1885). The Rockies continue into British Columbia.',
  }),
  choice('cg-35', 'Churchill, the “polar bear capital of the world”, is in which province?', ['Nunavut', 'Manitoba', 'Yukon', 'Quebec'], 'Manitoba', {
    emoji: '🐻‍❄️',
    weight: 1,
    points: 5,
    funFact: 'In Churchill people leave car doors unlocked — so anyone can hide if a polar bear strolls by.',
  }),
  choice('cg-36', 'Which of these is NOT one of the Great Lakes?', ['Lake Superior', 'Lake Ontario', 'Lake Winnipeg', 'Lake Erie'], 'Lake Winnipeg', {
    emoji: '🛶',
    weight: 1,
    points: 5,
    funFact: 'The five Great Lakes: Superior, Michigan, Huron, Erie, Ontario — HOMES is the trick to remember them.',
  }),
  choice('cg-37', 'Calgary, famous for its rodeo (the Stampede), is in which province?', ['Alberta', 'Saskatchewan', 'British Columbia', 'Manitoba'], 'Alberta', {
    emoji: '🤠',
    weight: 1,
    points: 5,
